...
- Focusing on what is best for the community as a whole, not just for us as
  individuals
...
This project involves a camera. Never post an image, a recording or a frame
containing a person who has not agreed to appear in it, including in an issue,
a pull request or a discussion. If you are reporting a problem that needs a
visual, record yourself, or record a hand against a plain background.
...
[GitHub](https://github.com/Amey-Thakur). All complaints will be reviewed and
...
the violation and an explanation of why the behaviour was inappropriate. A
